...
const CreatePodcast = () => {
  ...
  const [voiceType, setVoiceType] = useState<VoiceType | null>(null);  // Use VoiceType here
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col gap-2.5">
                  ...
                  <FormControl>
                    <Input className="input-class focus-visible:ring-offset-orange-1" placeholder="Your podcast's tile" {...field} />
                  </FormControl>
